...
module.exports = function login () {
  ...
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    models.sequelize.query('SELECT * FROM Products WHERE ((name LIKE ? OR description LIKE ?) AND deletedAt is NULL) ORDER BY name', { replacements: [req.body.email, security.hash(req.body.password)], model: UserModel, plain: true })
  ...
  function verifyPreLoginChallenges (req: Request) {
    ...
    challengeUtils.solveIf(challenges.dlpPasswordSprayingChallenge, () => { return req.body.email === 'J12934@' + config.get('application.domain') && req.body.password === '0Y8rMnww$*9VFYEÂ§59-!Fg1L6t&6lB' })
...
>>>>>>> 6a2ca40ce093e889f1ca3eb9930c39b6e1b8e11a
