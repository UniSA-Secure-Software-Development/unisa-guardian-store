...
module.exports = function login () {
  ...
  return async (req: Request, res: Response, next: NextFunction) => {
    ...
    await models.sequelize.query('SELECT * FROM Users WHERE email = :email AND password = :password AND deletedAt IS NULL', { replacements: { email: email, password: password }, model: UserModel, plain: true }) // vuln-code-snippet vuln-line loginAdminChallenge loginBenderChallenge loginJimChallenge
