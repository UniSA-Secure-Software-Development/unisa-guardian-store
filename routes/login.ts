...
module.exports = function login () {
  ...
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    models.sequelize.query('SELECT * FROM Users WHERE email = $user_email AND password = $user_password AND deletedAt IS NULL', { bind: { user_email: req.body.email || '', user_password: security.hash(req.body.password) || '' }, model: UserModel, plain: true })
