...
module.exports = function searchProducts () {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    const searchQuery = 'SELECT * FROM Products WHERE ((name LIKE :searchTerm OR description LIKE :searchTerm ) AND deletedAt IS NULL) ORDER BY name'
    models.sequelize.query(searchQuery, {
