...
module.exports = function searchProducts () {
  return (req: Request, res: Response, next: NextFunction) => {
    ...
    const criteriaWildcard = `%${criteria}%`
    models.sequelize.query( // vuln-code-snippet vuln-line unionSqlInjectionChallenge dbSchemaChallenge
      'SELECT * FROM Products WHERE ((name LIKE ? OR description LIKE ?) AND deletedAt IS NULL) ORDER BY name',
      {
        replacements: [criteriaWildcard, criteriaWildcard],
